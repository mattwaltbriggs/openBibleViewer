...
QHash<DockWidget*, Qt::DockWidgetArea> AdvancedInterface::docks()
{
    ...
    ret.insert(m_bibleManager->docks());
    ret.insert(m_notesManager->docks());
    ret.insert(m_searchManager->docks());
    ret.insert(m_bookmarksManager->docks());
    ret.insert(m_dictionaryManager->docks());
    return ret;
}
