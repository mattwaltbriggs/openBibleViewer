    ...
    m_ui(new Ui::WebForm)
{
    ...
    m_ui->toolButton_back->setIcon(m_view->page()->action(QWebEnginePage::Back)->icon());
    m_ui->toolButton_back->setToolTip(m_view->page()->action(QWebEnginePage::Back)->toolTip());

    m_ui->toolButton_forward->setIcon(m_view->page()->action(QWebEnginePage::Forward)->icon());
    m_ui->toolButton_forward->setToolTip(m_view->page()->action(QWebEnginePage::Forward)->toolTip());

    m_ui->toolButton_reloadStop->setIcon(m_view->page()->action(QWebEnginePage::Reload)->icon());
    m_ui->toolButton_reloadStop->setToolTip(m_view->page()->action(QWebEnginePage::Reload)->toolTip());
