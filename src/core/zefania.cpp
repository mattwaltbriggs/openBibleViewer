...
bool ZefaniaXmlReader::cmp(const QStringView &r, const QString &s)
{
...
BrFragment* ZefaniaXmlReader::rawReadBr(quint32 parent)
{
    ...
    const QStringView art = m_xml->attributes().value("art");
...
bool ZefaniaXmlReader::cmp(const QStringView& r, const ZefaniaXmlReader::TagName n)
{
    switch (n)
    {
        case AnyTop:
