...
void ModuleSettings::saveVersification()
{
    ...
    if(versificationFile != "") {
        ...
        QSharedPointer<Versification> sp = v11n.toStrongRef();
        const QMap<int, BookV11N> map = sp->data();
...
QSharedPointer<Versification> ModuleSettings::getV11n()
{
    ...
    QSharedPointer<Versification> v11nStrong = v11n.toStrongRef();
    if(v11nStrong) myDebug() << "versification loaded";
